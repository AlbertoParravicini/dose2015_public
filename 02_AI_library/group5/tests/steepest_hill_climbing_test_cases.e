...
class
	STEEPEST_HILL_CLIMBING_TEST_CASES
...
feature -- Test routines
	...
	steepest_hill_climbing_test_trivial_solution_1
			-- test case: WATER JAR (0,0,0)
		local
			engine: STEEPEST_HILL_CLIMBING_ENGINE [STRING, WATER_JAR_PUZZLE_STATE, WATER_JAR_PUZZLE]
	...
	steepest_hill_climbing_test_trivial_solution_2
	...
	steepest_hill_climbing_test_one_step_solution_1
	...
	steepest_hill_climbing_test_best_heuristic_solution_1
			-- test case: WATER JAR (0,0,0)
		local
			engine: STEEPEST_HILL_CLIMBING_ENGINE [STRING, WATER_JAR_PUZZLE_STATE, WATER_JAR_PUZZLE]
			jar_puzzle: WATER_JAR_PUZZLE
	...
	steepest_hill_climbing_test_best_heuristic_solution_2
	...
	steepest_hill_climbing_test_best_heuristic_solution_3
	...
	steepest_hill_climbing_test_sideways_moves
	...
	steepest_hill_climbing_test_sideways_moves_disabled
			-- test case: WATER JAR (1,0,0)
		local
			engine: STEEPEST_HILL_CLIMBING_ENGINE [STRING, WATER_JAR_PUZZLE_STATE, WATER_JAR_PUZZLE]
			jar_puzzle: WATER_JAR_PUZZLE
